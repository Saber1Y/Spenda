    ...
    <main className="flex min-h-screen items-center justify-center bg-paper-white px-4">
      <div className="w-full max-w-[400px] space-y-8">
        <div className="flex flex-col items-center gap-3">
          <Logo height={32} />
          <h1 className="font-heading text-heading-sm text-aubergine">Sign in to Spenda</h1>
          <p className="text-body-sm text-fog">Manage your agent&rsquo;s spend vault</p>
        </div>
        ...
        <p className="text-center text-body-sm text-fog">
          ...
          <Link href="/register" className="font-medium text-periwinkle transition hover:text-aubergine">
            Create one
          </Link>
        </p>
      </div>
